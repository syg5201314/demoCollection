...
public class ElemeBehavior extends CoordinatorLayout.Behavior<View> {

    public ElemeBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    private boolean isFirst = true;

    private ElemeHeaderView mDependency;

    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, View child, View dependency) {
        return dependency instanceof ElemeHeaderView;
    }
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        ...
        ViewPager viewPager = ((ElemeHeaderView) dependency).getViewPager();
    ...
    private void init(RecyclerView child, View dependency) {
        if (isFirst) {
            mDependency = (ElemeHeaderView) dependency;
            isFirst = false;
