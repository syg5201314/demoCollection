...
public class TransitionHelper {
    ...
    public static class BaseActivity extends ActionBarActivity implements Source, Listener {
    ...
    public static class BaseFragment extends Fragment implements Listener {
